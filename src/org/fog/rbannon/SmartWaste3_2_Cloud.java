 ...
 *
 */
public class SmartWaste3_2_Cloud {
	...
	private static void createFogDevices(int userId, String appId) {
		...
		FogDevice proxy = createFogDevice("proxy-server", 7000, 4000, 10000, 10000, 1, 0.0, 107.339, 83.4333);
	...
	private static FogDevice addArea(String id, int userId, String appId, int parentId){
		FogDevice router = createFogDevice("a-"+id, 5000, 4000, 10000, 10000, 2, 0.0, 107.339, 83.4333);
	...
	private static Application createApplication(String appId, int userId){
		 ...
		 */
		application.addAppEdge("BIN", "waste-info-module", 1000, 2000, "BIN", Tuple.UP, AppEdge.SENSOR); // adding edge from BIN (sensor) to Motion Detector module carrying tuples of type BIN
		...
		application.addAppEdge("master-module", "user_interface", 1000, 2000, "REQUEST_COLLECTION", Tuple.UP, AppEdge.MODULE); // adding edge from Object Detector to User Interface module carrying tuples of type REQUEST_COLLECTION
