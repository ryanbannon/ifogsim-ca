 ...
 *
 */
public class SmartWaste_Topology1 {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			PhysicalTopology physicalTopology = JsonToTopology.getPhysicalTopology(broker.getId(), appId, "topologies/SmartWaste_Topology1");
